...
mixin _$UserResponse {
 ...
 int? get id; String? get email; String? get password; String? get name; String? get role; String? get avatar;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,password,name,role,avatar);

@override
String toString() {
  return 'UserResponse(id: $id, email: $email, password: $password, name: $name, role: $role, avatar: $avatar)';
}
...
@useResult
$Res call({
 int? id, String? email, String? password, String? name, String? role, String? avatar
});
...
/// Create a copy of UserResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? email = freezed,Object? password = freezed,Object? name = freezed,Object? role = freezed,Object? avatar = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? email,  String? password,  String? name,  String? role,  String? avatar)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserResponse() when $default != null:
return $default(_that.id,_that.email,_that.password,_that.name,_that.role,_that.avatar);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? email,  String? password,  String? name,  String? role,  String? avatar)  $default,) {final _that = this;
switch (_that) {
case _UserResponse():
return $default(_that.id,_that.email,_that.password,_that.name,_that.role,_that.avatar);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? email,  String? password,  String? name,  String? role,  String? avatar)?  $default,) {final _that = this;
switch (_that) {
case _UserResponse() when $default != null:
return $default(_that.id,_that.email,_that.password,_that.name,_that.role,_that.avatar);case _:
  return null;
...
class _UserResponse extends UserResponse {
  const _UserResponse({this.id, this.email, this.password, this.name, this.role, this.avatar}): super._();
...
/// Create a copy of UserResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? email = freezed,Object? password = freezed,Object? name = freezed,Object? role = freezed,Object? avatar = freezed,}) {
